...
export const BentoGridItem = ({
  ...
  const leftLists = ["JADBio", "HuggingFace", "Anthropic","Copilot"];
  const rightLists = ["Pictory Ai", "Lalal Ai", "Tome AI"];
        ...
        >
          ...
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-8 relative z-1 p-0.5 rounded-2xl bg-conic-gradient">
